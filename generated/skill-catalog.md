...
> Generated: 2026-06-27T03:14:08.259Z
> Skills: 29
...
- `\b(vercel|vc)\s+metrics\b`
- `\bvercel\s+httpstat\b`
...
**Priority 6:** `auth`, `deployments-cicd`, `next-cache-components`, `next-forge`, `next-upgrade`, `routing-middleware`, `runtime-cache`, `shadcn`, `cdn-caching`
