...
> Generated: 2026-04-02T00:23:21.164Z
> Skills: 41
...
| `app/layout.tsx` | `next-cache-components` (6), `observability` (6), `nextjs` (5) |
| `src/app/layout.tsx` | `next-cache-components` (6), `observability` (6), `nextjs` (5) |
...
| `next dev` | `verification` (7), `next-cache-components` (6), `nextjs` (5), `agent-browser` (3), `agent-browser-verify` (2) |
| `next build` | `next-cache-components` (6), `nextjs` (5) |
| `next dev --turbo` | `verification` (7), `next-cache-components` (6), `nextjs` (5), `turbopack` (4), `agent-browser` (3), `agent-browser-verify` (2) |
...
**Priority 6:** `auth`, `cron-jobs`, `deployments-cicd`, `next-cache-components`, `next-forge`, `next-upgrade`, `observability`, `routing-middleware`, `runtime-cache`, `shadcn`, `sign-in-with-vercel`, `vercel-flags`

**Priority 5:** `ai-elements`, `micro`, `nextjs`, `turborepo`, `v0-dev`, `vercel-queues`, `zzz-test-empty-fp`

**Priority 4:** `json-render`, `react-best-practices`, `turbopack`, `vercel-agent`, `vercel-cli`, `vercel-sandbox`
