...
> Generated: 2026-09-18T20:57:12.033Z
> Skills: 36
...
| `chat-sdk` | 8 | 45 | 12 | 2 |
| `eve` | 8 | 2 | 8 | 1 |
| `vercel-functions` | 8 | 17 | 3 | 3 |
| `ai-gateway` | 7 | 0 | 6 | 2 |
| `create-a-backend` | 7 | 2 | 0 | 0 |
| `env-vars` | 7 | 10 | 4 | 0 |
| `microfrontends` | 7 | 4 | 6 | 1 |
| `vercel-firewall` | 7 | 0 | 1 | 0 |
| `vercel-services` | 7 | 2 | 1 | 0 |
| `vercel-storage` | 7 | 17 | 52 | 9 |
...
- `npm install flags @flags-sdk/vercel` (bash)
- `vercel flags create my-feature` (bash)
...
| `vercel flags create my-feature` | `flags-sdk` (6), `vercel-cli` (4) |
...
**Priority 7:** `ai-gateway`, `create-a-backend`, `env-vars`, `microfrontends`, `vercel-firewall`, `vercel-services`, `vercel-storage`, `verification`

**Priority 6:** `auth`, `cdn-caching`, `deployments-cicd`, `flags-sdk`, `next-cache-components`, `next-forge`, `next-upgrade`, `queues`, `routing-middleware`, `runtime-cache`, `shadcn`

**Priority 5:** `nextjs`, `vercel-connect`
