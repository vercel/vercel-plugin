...
> Generated: 2026-07-17T19:08:00.154Z
> Skills: 26
...
| `app/api/chat/route.ts` | `ai-sdk` (8), `chat-sdk` (8), `vercel-functions` (8) |
| `app/api/completion/route.ts` | `ai-sdk` (8), `vercel-functions` (8) |
| `components/ui/button.tsx` | `shadcn` (6), `react-best-practices` (4) |
| `.github/workflows/deploy.yml` | `deployments-cicd` (6), `vercel-agent` (4) |
| `app/api/bot/route.ts` | `chat-sdk` (8), `vercel-functions` (8) |
...
**Priority 6:** `auth`, `cdn-caching`, `deployments-cicd`, `next-forge`, `routing-middleware`, `runtime-cache`, `shadcn`

**Priority 5:** `vercel-connect`

**Priority 4:** `react-best-practices`, `vercel-agent`, `vercel-cli`, `vercel-sandbox`
