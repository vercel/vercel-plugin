...
> Generated: 2026-07-02T02:23:06.014Z
> Skills: 31
...
| `vercel logs` | `vercel-functions` (8), `cache-reason` (6), `vercel-cli` (4) |
...
**Priority 6:** `auth`, `cache-reason`, `cdn-caching`, `deployments-cicd`, `next-cache-components`, `next-forge`, `next-upgrade`, `routing-middleware`, `runtime-cache`, `shadcn`
