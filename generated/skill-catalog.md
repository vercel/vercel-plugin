...
> Generated: 2026-03-09T17:33:09.369Z
> Skills: 43
...
| `vercel dev` | `vercel-functions` (8), `vercel-cli` (4), `agent-browser` (3), `agent-browser-verify` (2) |
...
| `next dev` | `nextjs` (5), `agent-browser` (3), `agent-browser-verify` (2) |
| `next dev --turbo` | `nextjs` (5), `turbopack` (4), `agent-browser` (3), `agent-browser-verify` (2) |
| `npm run dev` | `nextjs` (5), `agent-browser` (3), `agent-browser-verify` (2) |
| `pnpm dev` | `nextjs` (5), `agent-browser` (3), `agent-browser-verify` (2) |
| `bun run dev` | `nextjs` (5), `agent-browser` (3), `agent-browser-verify` (2) |
...
**Priority 6:** `auth`, `cron-jobs`, `deployments-cicd`, `observability`, `routing-middleware`, `runtime-cache`, `shadcn`, `sign-in-with-vercel`, `vercel-flags`
