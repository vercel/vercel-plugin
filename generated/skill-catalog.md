...
> Generated: 2026-03-07T01:46:16.567Z
> Skills: 42
...
| `env-vars` | 7 | 10 | 4 | 0 |
| `vercel-api` | 7 | 2 | 6 | 0 |
| `vercel-storage` | 7 | 15 | 48 | 0 |
| `auth` | 6 | 14 | 12 | 0 |
| `cron-jobs` | 6 | 2 | 0 | 0 |
| `deployments-cicd` | 6 | 6 | 7 | 0 |
| `observability` | 6 | 17 | 28 | 0 |
...
**Priority 6:** `auth`, `cron-jobs`, `deployments-cicd`, `observability`, `routing-middleware`, `runtime-cache`, `sign-in-with-vercel`, `vercel-flags`, `workflow`

**Priority 5:** `ai-elements`, `nextjs`, `payments`, `shadcn`, `turborepo`, `v0-dev`, `vercel-firewall`, `vercel-queues`

**Priority 4:** `cms`, `edge-runtime`, `email`, `geist`, `json-render`, `micro`, `ncc`, `satori`, `streamdown`, `styled-jsx`, `swr`, `turbopack`, `vercel-agent`, `vercel-cli`, `vercel-sandbox`
