...
description: "Vercel Ecosystem Relational Knowledge Graph — maps every product, library, CLI, API, and service. Use when asked broad platform questions like 'which Vercel product should I use?' or 'compare Workflow vs Queues vs Functions'."
user-invocable: true
---
