...
retrieval:
  aliases: ["chat ui", "chatbot", "conversation interface", "messaging component"]
  intents: ["build chatbot", "add chat interface", "create messaging ui", "implement chat feature"]
  entities: ["useChat", "Message", "ChatUI", "StreamingMessage", "chat-sdk"]
chainTo:
  - pattern: "from\\s+[''\"\"]openai[''\"\"]"
    targetSkill: ai-sdk
    message: "Direct OpenAI SDK import in chat bot — loading AI SDK guidance for unified provider abstraction and streaming."
...
Guidance for chat-sdk. Install from registry for full content.
