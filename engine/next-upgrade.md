...
retrieval:
  aliases: ["next upgrade", "nextjs migration", "next codemod"]
  intents: ["upgrade Next.js to latest version", "run Next.js codemods", "migrate between major Next.js versions"]
  entities: ["codemod", "migration", "upgrade", "breaking changes"]
---

Guidance for next-upgrade. Install from registry for full content.
