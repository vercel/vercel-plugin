...
retrieval:
  aliases: ["durable workflow", "long running task", "step function", "orchestration"]
  intents: ["build workflow", "add retry logic", "create durable task", "implement step function"]
  entities: ["Workflow DevKit", "WDK", "step", "pause/resume", "durable"]
chainTo:
  - pattern: "DurableAgent|@workflow/ai"
    targetSkill: ai-sdk
    message: "DurableAgent detected without AI SDK context — loading AI SDK guidance for tool calling, Agent class, and model configuration."
...
Guidance for workflow. Install from registry for full content.
