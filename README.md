...
| Skill | Registry |
|-------|----------|
| `agent-browser` | [vercel/vercel-skills](https://github.com/vercel/vercel-skills) |
| `ai-elements` | [vercel/vercel-skills](https://github.com/vercel/vercel-skills) |
| `ai-sdk` | [vercel/vercel-skills](https://github.com/vercel/vercel-skills) |
| `next-cache-components` | [vercel/vercel-skills](https://github.com/vercel/vercel-skills) |
| `next-upgrade` | [vercel/vercel-skills](https://github.com/vercel/vercel-skills) |
| `nextjs` | [vercel/vercel-skills](https://github.com/vercel/vercel-skills) (as `next-best-practices`) |
| `react-best-practices` | [vercel/vercel-skills](https://github.com/vercel/vercel-skills) (as `vercel-react-best-practices`) |
| `turborepo` | [vercel/vercel-skills](https://github.com/vercel/vercel-skills) |
| `deployments-cicd` | [vercel/vercel-skills](https://github.com/vercel/vercel-skills) (as `vercel-deploy`) |
| `vercel-cli` | [vercel-labs/agent-skills](https://github.com/vercel-labs/agent-skills) (as `vercel-cli-with-tokens`) |
