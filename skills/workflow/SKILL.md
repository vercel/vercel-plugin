...
chainTo:
  -
    ...
    targetSkill: ai-sdk
    message: 'DurableAgent (@workflow/ai) is deprecated — use WorkflowAgent from @ai-sdk/workflow. Loading AI SDK guidance for tool calling, the Agent class, and model configuration.'
