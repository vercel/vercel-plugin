...
validate:
  ...
  -
    ...
    severity: recommended
    upgradeToSkill: nextjs
    upgradeWhy: 'Explains that cacheHandler (singular, ISR/route handler/image caching) and cacheHandlers (plural, for the use cache directive) are separate, non-interchangeable Next.js 16 configs.'
  -
    pattern: useRef\(\s*\)
